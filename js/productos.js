...
createApp({
  data() {
    ...
    return {
      ...
      url: "https://fedco.pythonanywhere.com/productos", // URL del backend donde se encuentran los productos
      error: false,
      cargando: true,
    ...
    grabar() {
      ...
      fetch(this.url, options)
        .then(function () {
          ...
          window.location.href = "./producto-create.html"; // Redirigir a la página de productos
        })
        .catch((err) => {
          console.error(err);
